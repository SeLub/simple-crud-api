...
Перед тестами сотановите сервер командой _Ctrl-C_!
...
Для вашего удобства проверки в Postman, я экспортировал коллекцию API использовавшихся для разработки и тестирования сервера. Она находится в папке __postman_collection__

Вы можете [раскомментировать тестового пользователя](https://github.com/SeLub/simple-crud-api/blob/develop/models.js) в файле "базы данных" и запросами из Postman проверить работу. 
