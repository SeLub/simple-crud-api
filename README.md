...
## Отправка невалидного json приводит к падению приложения 

Данный вопрос обсуждался на стриме : https://www.youtube.com/watch?v=ogCL5c8bhUQ
и Максим дал рекомендации оценки.

Снимается -5 баллов, вместо 10. Т.к. у меня частичная реализация. Я их уже снял.
